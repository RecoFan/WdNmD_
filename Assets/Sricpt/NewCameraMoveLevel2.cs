...
public class NewCameraMoveLevel2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cameraLocationList = new float[stageCount][];
        ...
        cameraLocationList[15] = new float[] { 544.73f, 136f };

        stageList = new float[stageCount][];
        ...
        stageList[15] = new float[] { 0, 0, 0, 0 };
